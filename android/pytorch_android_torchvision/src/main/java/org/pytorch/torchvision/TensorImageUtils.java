...
public final class TensorImageUtils {
  ...
  /**
   * Creates new {@org.pytorch.Tensor} from full {@link android.graphics.Bitmap}, normalized with
   * specified in parameters mean and std.
   *
   * @param normMeanRGB means for RGB channels normalization, length must equal 3 and order must be
   *                    RGB
   * @param normStdRGB  standard deviation for RGB channels normalization, length must equal 3 and
   *                    order must be RGB
   */
  ...
  /**
   * Creates new {@org.pytorch.Tensor} from specified area of {@link android.graphics.Bitmap},
  ...
  /**
   * Creates new {@org.pytorch.Tensor} from specified area of {@link android.media.Image}, doing
   * optional rotation, scaling (nearest) and center cropping.
   *
   ...
   * @param normMeanRGB     means for RGB channels normalization, length must equal 3 and order
   *                        must be
   *                        RGB
   * @param normStdRGB      standard deviation for RGB channels normalization, length must equal
   *                        3 and
   *                        order must be RGB
   */
